...
@property (class, nonatomic, assign, readonly, nonnull) NSString *faceTecApiBaseUrl NS_REFINED_FOR_SWIFT;

@property (class, nonatomic, assign, readonly, nonnull) NSString *faceTecApiBearerToken NS_REFINED_FOR_SWIFT;
